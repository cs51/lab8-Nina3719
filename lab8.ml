...
struct
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let new_id1 = new_id () in
    let newWaiter = { id = new_id1 ; action = listener} in
    evt := !evt @ [newWaiter];
    new_id1 ;;
...
......................................................................*)
let _ = WEvent.remove_listener newswire fake;;
let _ = WEvent.remove_listener newswire buzz;;
(* .. *)
...
let receive_report arg = let _ = WEvent.add_listener publish arg in ();;
